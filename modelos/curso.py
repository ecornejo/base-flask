...
class CursoModel(db.Model):
    ...
    profesor = db.relationship('ProfesorModel')
    ...
    def __init__(self, nombre, id_profesor, nivel, activo=None, id=None):
        self._id = id
        self.nombre = nombre
    ...
    def obtener_datos(self):
        ...
        return {'id': self.id, 'nombre': self.nombre, 'nivel': self.nivel, 'activo':  self.activo, 'profesor':dataProfesor}
